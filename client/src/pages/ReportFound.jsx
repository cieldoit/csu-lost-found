...
import { Camera, MapPin, Tag, FileText, Send, X, ArrowLeft, Image as ImageIcon, Package, Archive } from "lucide-react";
  ...
  if (success) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <h2 className="text-3xl font-bold text-slate-900 mb-2">Found Report Submitted!</h2>
        <p className="text-slate-500 text-lg">Thank you for being a hero! Redirecting to dashboard...</p>
      </div>
    );
  }
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-3 space-y-6">
          <div className="glass-card p-8 rounded-4xl space-y-6">
            ...
            <div>
              <label className="flex items-center gap-2 text-sm font-bold text-slate-700 mb-2 ml-1">
                <Archive size={16} className="text-primary" /> Storage Location (Optional)
              </label>
              <input
